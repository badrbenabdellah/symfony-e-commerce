...
class ProductController extends AbstractController
{
    ...
    public function delete(Request $request, Product $product, EntityManagerInterface $entityManager): Response
    {
        ...
        $this->addFlash('danger', 'Your Product has been Deleted');
        return $this->redirectToRoute('app_product_index', [], Response::HTTP_SEE_OTHER);
    }
    ...
    public function addStock($id, EntityManagerInterface $entityManager, Request $request, ProductRepository $productRepository):Response
    {
        ...
        if($form->isSubmitted() && $form->isValid()) {
            if($addStock->getQuantity() > 0) {
                ...
                $this->addFlash("success", "The Stock of your Product has been modified");
                return $this->redirectToRoute("app_product_index");
            }
            else{
                $this->addFlash("danger", "The Stock must not be less than 0");
